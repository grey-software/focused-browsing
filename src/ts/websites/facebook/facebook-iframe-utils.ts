...
function createFacebookIframe(): HTMLIFrameElement {
...
function setIframeSource(feedIframe: HTMLIFrameElement): void {
  ...
  if (isDarkMode) {
    feedIframe.src = browser.runtime.getURL('html/facebookDark.html')
  } else {
    feedIframe.src = browser.runtime.getURL('html/facebook.html')
  }
}
...
export default { createFacebookIframe, setIframeSource, injectFeedIframe }
