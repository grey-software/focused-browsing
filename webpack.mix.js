...
mix.setPublicPath('./')
    ...
    .ts('src/ts/Twitter/TwitterController.ts', 'extension-build/js/Twitter')
    .ts('src/background.ts', 'extension-build')
    .ts('src/ts/feed-card-controller.ts', 'extension-build/js').vue()
    .ts('src/ts/popup-card-controller.ts', 'extension-build/js').vue()
    .options({
